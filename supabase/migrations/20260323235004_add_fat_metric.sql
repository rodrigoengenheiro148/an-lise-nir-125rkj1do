...
ADD COLUMN IF NOT EXISTS fat_lab double precision DEFAULT 0,
ADD COLUMN IF NOT EXISTS fat_nir double precision DEFAULT 0,
ADD COLUMN IF NOT EXISTS fat_anl numeric;
