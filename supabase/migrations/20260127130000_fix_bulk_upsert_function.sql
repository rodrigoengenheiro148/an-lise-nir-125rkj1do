...
BEGIN
    ...
    LOOP
        ...
        -- matching company, date, material and submaterial
        -- Uses IS NOT DISTINCT FROM to correctly handle NULLs in date, material or submaterial
        SELECT id INTO existing_id
        FROM analysis_records
        WHERE company_id = rec_company_id
          AND date IS NOT DISTINCT FROM rec_date
          AND material IS NOT DISTINCT FROM rec_material
